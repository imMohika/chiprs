...
use crate::emu::constants::{
    RAM_SIZE, SCREEN_HEIGHT, SCREEN_WIDTH, STACK_SIZE, START_ADDR, V_SIZE,
};
...
impl Emulator {
    ...
    fn execute(&mut self, op: u16) {
        ...
        match (d1, d2, d3, d4) {
            ...
            // TODO)) EX9E: skip if VX key is pressed
            // TODO)) EXA1: skip if VX key is not pressed
            ...
            // FX29: font character
            (0xF,_,2,9) => {
                self.i_reg = (self.v_reg[d2 as usize] * 5) as u16
            }
